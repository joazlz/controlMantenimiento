...
public class LibraryResourceTest {
    ...
    public void testLibrary() throws Exception {
        ...
        RestAssured.given()
                ...
                .formParam("nombre", "sherry")
                .put("/inventario/area/")
                .then()
                .statusCode(204);

        // Integer sherryLodgeId = RestAssured.when().get("/inventario/area/search?pattern=sherry*").then()
        //         .statusCode(200)
        //         .body("nombre", contains("sherry"),contains("Wrong"))
        //         .extract().path("[0].id");
