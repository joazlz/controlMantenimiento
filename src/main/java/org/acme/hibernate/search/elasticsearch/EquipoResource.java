...
public class EquipoResource {
    ...
    void onStart(@Observes StartupEvent ev) throws InterruptedException {
        ...
        //            .startAndWait();
        // }
        // if (CapacidadBTU.count() > 0) {
        //    searchSession.massIndexer()
        //            .startAndWait();
        // }
        
        // if (TipoMotor.count() > 0) {
        //    searchSession.massIndexer()
        //            .startAndWait();
        // }
        // if (Estado.count() > 0) {
        ...
        //            .startAndWait();
        // }
        // if (Presostato.count() > 0) {
        //    searchSession.massIndexer()
        //            .startAndWait();
        // }
        // if (TipoCompresor.count() > 0) {
        //    searchSession.massIndexer()
        //            .startAndWait();
        // }
        ...
        //            .startAndWait();
        // }
        // if (TipoFiltroDeshidratador.count() > 0) {
        //    searchSession.massIndexer()
        //            .startAndWait();
        // }
    }
    ...
    // TipoMantenimiento
     ...
     @Path("tiponotificacion/{id}")
     @Transactional
     public void eliminarTT(Long id) {
         TipoNotificacion tipoNotificacion = TipoNotificacion.findById(id);
         if (tipoNotificacion != null) {
